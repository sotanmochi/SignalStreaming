...
{
    public sealed class ClientConnectionResponseFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::SignalStreaming.ClientConnectionResponse>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::SignalStreaming.ClientConnectionResponse value, global::MessagePack.MessagePackSerializerOptions options)
        {
        ...
        public global::SignalStreaming.ClientConnectionResponse Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        __ClientId__ = reader.ReadUInt32();
                        break;
                    case 2:
            ...
            var ____result = new global::SignalStreaming.ClientConnectionResponse(__RequestApproved__, __ClientId__, __ConnectionId__, __Message__);
            reader.Depth--;
            return ____result;
        }
    }
